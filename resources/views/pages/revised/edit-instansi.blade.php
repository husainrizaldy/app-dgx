...
@section('title', 'Revisi - Pengajuan Usulan Instansi')
...
<div class="container mx-auto">
    ...
    <div class="w-11/12 mx-auto bg-white shadow-md rounded-lg p-8 border border-gray-200">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Revisi - Pengajuan Usulan Instansi</h2>
        <form 
            action="{{ route('submission.update.instansi', $submission->uuid) }}" 
            method="POST" 
                    ...
                    <div class="border border-gray-300 rounded-md p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label for="adhoc_admin_name" class="block text-sm/6 font-medium text-gray-700">Admin Tim AdHoc Internal UG  <span class="text-red-500">*</span></label>
                                    <div class="mt-2">
                                        <input type="text" name="adhoc_admin_name" id="adhoc_admin_name" value="{{ old('adhoc_admin_name', $submission->adhoc_admin_name) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="adhoc_admin_position" id="adhoc_admin_position" value="{{ old('adhoc_admin_position', $submission->adhoc_admin_position) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            ...
                            <div>
                                <div class="mb-2">
                                    <label for="team_leader_name" class="block text-sm/6 font-medium text-gray-700">Ketua Tim AdHoc  <span class="text-red-500">*</span></label>
                                    <div class="mt-2">
                                        <input type="text" name="team_leader_name" id="team_leader_name" value="{{ old('team_leader_name', $submission->team_leader_name) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                ...
                                <div class="mb-2">
                                    <label for="external_responsible_name" class="block text-sm/6 font-medium text-gray-700">Penanggung Jawab External  <span class="text-red-500">*</span></label>
                                    <div class="mt-2">
                                        <input type="text" name="external_responsible_name" id="external_responsible_name" value="{{ old('external_responsible_name', $submission->external_responsible_name) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                ...
                                <div class="mb-2">
                                    <label for="external_institution_name" class="block text-sm/6 font-medium text-gray-700">Nama Institusi Eksternal  <span class="text-red-500">*</span></label>
                                    <div class="mt-2">
                                        <input type="text" name="external_institution_name" id="external_institution_name" value="{{ old('external_institution_name', $submission->external_institution_name) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start border border-gray-300 rounded-md p-4 max-w-3xl">
                    <div>
                        <label for="collaboration_document" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div>
                        ...
                        @if ($submission->collaboration_document)
                            <a href="{{ asset('storage/submissions/' . $submission->collaboration_document) }}" 
                                target="_blank" 
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-purple-700 bg-purple-100 
                                    border border-purple-300 rounded-md hover:bg-purple-200 transition">
                                Lihat / Unduh
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start border border-gray-300 rounded-md p-4 max-w-3xl">
                    <div>
                        <label for="adhoc_team_document" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div>
                        ...
                        @if ($submission->adhoc_team_document)
                            <a href="{{ asset('storage/submissions/' . $submission->adhoc_team_document) }}" 
                                target="_blank" 
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-purple-700 bg-purple-100 
                                    border border-purple-300 rounded-md hover:bg-purple-200 transition">
                                Lihat / Unduh
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start border border-gray-300 rounded-md p-4 max-w-3xl">
                    <div>
                        <label for="external_profile_document" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div>
                        ...
                        @if ($submission->external_profile_document)
                            <a href="{{ asset('storage/submissions/' . $submission->external_profile_document) }}" 
                                target="_blank" 
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-purple-700 bg-purple-100 
                                    border border-purple-300 rounded-md hover:bg-purple-200 transition">
                                Lihat / Unduh
