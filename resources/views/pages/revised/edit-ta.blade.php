...
@section('title', 'Revisi - Pengajuan Usulan TA')
...
<div class="container mx-auto">
    ...
    <div class="w-11/12 mx-auto bg-white shadow-md rounded-lg p-8 border border-gray-200">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Revisi - Pengajuan Usulan TA</h2>

        <form 
            action="{{ route('submission.update.ta', $submission->uuid) }}" 
            method="POST" 
            ...
            <div class="flex flex-col-reverse md:flex-row gap-4">
                ...
                <div class="md:basis-2/3">
                    <div class="border border-gray-300 rounded-md p-4">
                        <!-- Konten kiri -->
                        {{-- <p class="font-semibold text-gray-700">Konten Kiri (8/12)</p> --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label for="supervisor_1" class="block text-sm/6 font-medium text-gray-700">Pembimbing 1</label>
                                    <div class="mt-2">
                                        <input 
                                            type="text" 
                                            name="supervisor_1" 
                                            id="supervisor_1" 
                                            value="{{ old('supervisor_1', $submission->supervisor_1) }}" 
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="supervisor_2" class="block text-sm/6 font-medium text-gray-700">Pembimbing 2</label>
                                    <div class="mt-2">
                                        <input 
                                            type="text" 
                                            name="supervisor_2" 
                                            id="supervisor_2" 
                                            value="{{ old('supervisor_2', $submission->supervisor_2) }}" 
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="supervisor_3" class="block text-sm/6 font-medium text-gray-700">Pembimbing 3</label>
                                    <div class="mt-2">
                                        <input type="text" name="supervisor_3" id="supervisor_3" value="{{ old('supervisor_3', $submission->supervisor_3) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="mb-2">
                                    <label for="research_field" class="block text-sm/6 font-medium text-gray-700">Bidang Penelitian  <span class="text-red-500">*</span></label>
                                    <div class="mt-2">
                                        <input type="text" name="research_field" id="research_field" value="{{ old('research_field', $submission->research_field) }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                ...
                <div class="md:basis-1/3">
                    <div class="border border-gray-300 rounded-md p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <label for="member_id" class="block text-sm/6 font-medium text-gray-700 mb-2">Nama Mahasiswa</label>
