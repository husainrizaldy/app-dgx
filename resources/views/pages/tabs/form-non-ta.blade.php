<div class="bg-white shadow-md rounded-lg p-8 border border-gray-200">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Formulir Pengajuan Usulan Non TA</h2>

{{-- @dd(Auth::guard('member')->user()->id); --}}
    <form action="{{ route('submission.store.nonta', ['tab' => 'non-ta']) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <div class="mb-2">
                    ...
                    <div class="mt-2">
                        <input type="hidden" name="research_type_id" value="2">
                        <input 
                            type="text"
                            id="research_type_id_display"
                            value="Penelitian Non TA"
                            readonly
            ...
            <div>
                <div class="mb-2">
                    <label for="member_id" class="block text-sm/6 font-medium text-gray-700">Nama Peneliti</label>
                    <div class="mt-2">
            ...
            <div>
                <div class="mb-2">
                    ...
                    <div class="mt-2">
                        <input type="text" name="research_title" id="research_title" value="{{ old('research_title') }}" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
