<div class="bg-white shadow-md rounded-lg p-8 border border-gray-200">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Formulir Pengajuan Usulan TA</h2>

{{-- @dd(Auth::guard('member')->user()->id); --}}
    <form action="{{ route('submission.store.ta', ['tab' => 'ta']) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <div class="mb-2">
                    ...
                    <div class="mt-2">
                        <input type="hidden" name="research_type_id" value="1">
                        <input 
                            type="text"
            ...
            <div>
                <div class="mb-2">
                    <label for="member_id" class="block text-sm/6 font-medium text-gray-700">Nama Mahasiswa</label>
                    <div class="mt-2">
                        <input type="hidden" name="member_id" value="{{ Auth::guard('member')->user()->id }}">
                        <input type="hidden" name="researcher_name" value="{{ Auth::guard('member')->user()->name }}">
                        <input 
                            type="text"  
                            id="member_id_display" 
